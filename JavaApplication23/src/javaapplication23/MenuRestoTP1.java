...
public class MenuRestoTP1 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Ce variable sert à ne pas faire un loop infini, et de recommencer la commande.
         */
        int loop = 0;
        while (loop == 0) {
            /**
             * Ces 6 premiers variables servent à définir le prix des items du menu.
             */
            ...
            /**
             * Les 6 prochains variables servent à définir le nombre de fois qu'un item à été choisi.
             */
            int fritesnb = 0;
            int brochettesnb = 0;
            int Ppizzanb = 0;
            ...
            int macaronnb = 0;
            /**
             * Les 6 prochains varaibles servent à définir la quantité totale d'un item commandé.
             */
            int fritestotal = 0;
            ...
            int macarontotal = 0;
            /**
             * Ce variable enregistre la commande de l'utilisateur.
             */
            int commande;
            /**
             * Ce variable enregistre la quantité commandé par l'utilisateur.
             */
            int quantite;
            /**
             * Ce variable représente le sous-total.
             */
            double totale = 0;
            /**
             * Ce variable représente le rabais.
             */
            double rabais = 0;
            /**
             * Ce variable représente si l'utilisateur veux quitter ou faire une nouvelle commande.
             */
            int quit;
            ...
            if (commande < 1) {
                ...
                /**
                 * Cela est le compteur. Il sert à compter le nombre de commandes faits par l'utilisateur et de ne pas faire un loop infini.
                 */
                int compteur = 0;
